...
const RecentChat = ({ title, icon }) => {
  return (
    <div className='flex items-center justify-between h-9 pl-3 pr-2 rounded-lg text-text-primary hover:bg-surface-hover/50 cursor-pointer group transition-all duration-150 w-full'>
