...
const RecentChat = ({
  ...
  return (
    <div className='relative w-full'>
      ...
      >
        {/* Chat title or Skeleton */}
        {isGeneratingTitle ? (
          <div className="animate-pulse h-5 w-3/4 bg-surface-hover rounded-md flex-1 min-w-0 pr-2 my-auto" />
        ) : (
